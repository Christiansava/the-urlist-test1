  ...
  return (
    <div ref={setNodeRef} style={style} className="flex gap-2 items-start">
      ...
      <div className="flex-1">
        <LinkItem link={link} onUpdate={onUpdate} onDelete={onDelete} />
      </div>
    </div>
  );
}

export default function ListContainer({ listId, initialLinks = [] }: ListContainerProps) {
  ...
  return (
    <div className="space-y-6">
      <AddLink listId={listId} onLinkAdded={handleLinkAdded} />
